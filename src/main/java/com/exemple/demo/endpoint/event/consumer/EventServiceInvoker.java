package com.exemple.demo.endpoint.event.consumer;

import com.exemple.demo.PojaGenerated;
import com.exemple.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.exemple.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.exemple.demo.service.event."
