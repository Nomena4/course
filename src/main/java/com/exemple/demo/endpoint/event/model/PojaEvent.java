package com.exemple.demo.endpoint.event.model;

import static com.exemple.demo.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.exemple.demo.PojaGenerated;
import com.exemple.demo.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "com.exemple.demo.event1";
  }
}
